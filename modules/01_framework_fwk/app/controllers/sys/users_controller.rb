class Sys::UsersController < ApplicationController
  ...
  def destroy
    @sys_user.destroy
    respond_to do |format|
      format.html { redirect_to sys_users_url, notice: 'User was successfully destroyed.' }
  ...
  private
    ...
    def sys_user_params
      params.require(:sys_user).permit(:login_name, :first_name, :last_name, :full_name, :email, :phone, :locked_flag, :locked_time, :locked_until_at, :status)
    end
end
